...
function carta(array,template) {
    ...
    for(var i = 0; i< array.length; i++){
        ...
        <div class="card-body">
            ...
            <p class="card-height card-text text-center">${array[i].description}</p>
...
function combinacionFiltro(){
    ...
    if(filtroCheck.length > 0 && searchText !== ""){//estoy diciendo que mi if filtre de manera combinada el search y el input
        filtroCheck.map(checking=> {
            contenedorFiltro.push(...arrayData.filter(searching=>searching.name.toLowerCase().includes(searchText.toLowerCase().trim()) 
